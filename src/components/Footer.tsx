      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="#routes" className="hover:text-sunset-orange transition-colors">Popular Routes</a></li>
              <li><a href="#vehicles" className="hover:text-sunset-orange transition-colors">Our Fleet</a></li>
        ...
        <div className="pt-8 border-t border-cedar-brown/30 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 text-sm">
            ...
            <a href="#" className="hover:text-sunset-orange transition-colors">Terms of Service</a>
            <a href="#" className="hover:text-sunset-orange transition-colors">Refund Policy</a>
          </div>
        </div>
      </div>
    </footer>
